      ...
      <div class="event-reg-content">
		...
		<?php 
			...
			//String Validation  
				...
				if (empty($_POST["anei_member"])) {  
						$anei_memberErr = "anei_member is required";  
				} else {  
			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" >
			  <div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-6">
					...
					<input type="text" class="form-control" placeholder="Enter first Name"  name="firstname" required="true" >
				...
				<div class="col-lg-6 col-md-6 col-sm-6" id="ifcategory" style="display: none;">
					...
					<input type="text" class="form-control"  placeholder="Enter Other Category"  name="other_cat"  >
				  </div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="form-group">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					...
					<input type="text" class="form-control"  placeholder="Enter phone"  name="phone" required="true" >
				...
				<div class="col-lg-6 col-md-6 col-sm-6" id="ifYes" style="display: none;">
					...
					<input type="text" class="form-control"  placeholder="Enter ANEI Number"  name="anei_number"  >
				  </div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6">
					<div class="form-group">
					<label>Name of the Organization<span>*</span></label>
					<input type="text" class="form-control"  placeholder="Enter Name of the Organization"  name="organisation" required="true" >
				...
				<div class="col-lg-6 col-md-6 col-sm-6" id="ifothercountry" style="display: none;">
					...
					<input type="text" class="form-control"  placeholder="Enter Other Country"  name="other_country"  >
				  </div>
				</div>
